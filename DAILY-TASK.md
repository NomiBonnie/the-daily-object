...
候选1: [作品名] ([年份]) — [关联类型: 生日/逝世/发布/获奖/...]
  知名度: X/5 | 图片: X/5 | 故事: X/5 | 视觉: X/5 | 分类多样性: X/5 | 时代加权: 0/-3 | 总分: XX/25
候选2: [作品名] ([年份]) — [关联类型: ...]
  知名度: X/5 | 图片: X/5 | 故事: X/5 | 视觉: X/5 | 分类多样性: X/5 | 时代加权: 0/-3 | 总分: XX/25
候选3: [作品名] ([年份]) — [关联类型: ...]
  知名度: X/5 | 图片: X/5 | 故事: X/5 | 视觉: X/5 | 分类多样性: X/5 | 时代加权: 0/-3 | 总分: XX/25
...
**⑥ 时代加权（Sam 铁规 2026-03-28）**

| 年代 | 规则 |
|------|------|
| 1950 年后 | ✅ 优先选择，现代人更熟悉 |
| 1950 年前 | ⚠️ 总分 -3 分惩罚，除非 impact 极大且流芳百世（如包豪斯、蒙德里安、Eames）|
| 判断标准 | 1950 前作品必须满足：现代人依然一眼认得 + 出现在设计史必修教科书 + 影响力跨越时代至今 |

> 像书籍封面插画、早期海报等，即使当年有影响力，如果现代人看到不会有"哇"的感觉，就不选。

**总分计算：** ① + ② + ③ + ④ + ⑤ + ⑥时代加权，满分 25（⑥为减分项，不加分）。
- **≥ 18 分**：直接选
...
| 08-05 | The Seven Year Itch “Subway Dress” | William Travilla | fashion |
