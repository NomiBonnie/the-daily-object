...
当 Peter Blake 把波普艺术的拼贴方法应用到一张33转唱片的 12 英寸方块上时,他不仅创造了一件艺术品,更定义了一种新的文化载体。那67个名人剪影的选择过程本身就是一次文化策展:每位 Beatles 成员提交了自己的名单, Lennon 要了 Jesus(被唱片公司否决)和 Hitler(被 Blake 自己否决),McCartney 选了 Fred Astaire 和 William Burroughs,Harrison 的名单几乎全是印度上师。最终的群像是一张1960年代反文化运动的人物图谱,从 Aleister Crowley(神秘学家)到 Karlheinz Stockhausen(先锋作曲家),从 Mae West(最初拒绝出现,后来被劝说同意)到 Bob Dylan。每一个选择都值得写一篇论文。

从此,买一张唱片不只是买音乐,而是买一件可以端详、讨论、解码的视觉作品。这个观念在黑胶唱片时代达到巅峰(12英寸的方形画幅足够承载复杂的视觉叙事),在CD时代缩水(封面缩小到12厘米见方,细节全部丢失),在数字流媒体时代几乎消亡(Spotify 上的专辑封面只有几百像素的缩略图)。但讽刺的是,2020年代黑胶唱片的复兴让这个轮回再次转动:年轻人重新开始购买实体唱片,很大程度上是因为他们渴望那种"拿在手里、对着光看、在内页里找彩蛋"的体验。Sgt. Pepper's 在1967年定义的那个观念,在将近六十年后仍然是唱片文化最核心的吸引力。`,
