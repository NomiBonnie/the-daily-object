...
Twenty-five years on, Tate Modern remains the first reference for industrial heritage conversion projects worldwide, and the most persuasive evidence that architecture need not always start from zero.`,
  },
  {
    ...
    dateConnection: `1893年4月20日,Joan Miró 出生于巴塞罗那。这位加泰罗尼亚人用色彩、线条和符号创造了一套全新的视觉语言--没有他,20世纪的平面设计会是另一个样子。1982年西班牙世界杯的标志、La Caixa 银行的星形logo、甚至今天大量科技公司"有机"风格的品牌设计,都能追溯到 Miró 的影响。而他最具代表性的画作之一,就是1924年在巴黎一间狭小画室里完成的这幅《Harlequin's Carnival》。`,
    designerBio: `Joan Miró(1893-1983)生于巴塞罗那一个金匠和钟表匠的家庭。父亲希望他做生意,19岁时他因为在一家文具公司当会计而精神崩溃,大病一场。康复后,家人终于同意他全职学画。

1920年,27岁的 Miró 第一次去巴黎。他住在一个连暖气都没有的画室里--隔壁就是 André Masson 的工作室。通过 Masson,Miró 认识了超现实主义的圈子:André Breton、Paul Éluard、Max Ernst。但 Miró 从来不是"正统"的超现实主义者--他拒绝弗洛伊德式的符号解读,也不做自动书写。他的方法更简单也更极端:饿到产生幻觉,然后把看到的东西画下来。

"我饿得太厉害了,"他后来说,"我开始在墙上看到各种形状。我把它们记在纸上。"

这种因匮乏而生的创造力,成了他一生创作的起点。`,
    story: `1924年的巴黎,Miró 穷得只能吃干面包。画室很小,冬天冷得手僵。但正是在这种极端条件下,他画出了自己最重要的作品之一。

《Harlequin's Carnival》画面上挤满了几十个奇异的生物--音符长了翅膀,梯子通向虚空,昆虫在弹吉他,一只猫在和毛线球玩耍,窗外能看到一座三角形的埃菲尔铁塔和一颗闪烁的星星。中间那个"Harlequin"--小丑--身体被分成两半,一半红一半蓝,长着一根大胡子和一只巨大的耳朵。

这不是混乱,是精心编排的混乱。每个元素都经过反复推敲--Miró 留下了大量草图证明这一点。他把童年在加泰罗尼亚乡下看到的昆虫、动物、星星,和巴黎生活中的饥饿、孤独、音乐混在一起,创造了一个完整的微型宇宙。

这幅画1925年在 Pierre Loeb 画廊首次展出时,André Breton 立刻宣布 Miró 是"最超现实主义的画家"。但 Miró 的"超现实"和 Dalí 的不同--他不画融化的钟表或燃烧的长颈鹿。他创造的是一套**符号系统**:星星、月亮、眼睛、鸟、女人,这些符号反复出现在他之后60年的创作中,像一种私人字母表。

正是这套符号系统--简洁、有力、可复制--让 Miró 的影响力远远溢出了画布的边界,渗透到了平面设计、品牌识别、甚至字体设计的领域。`,
    legacy: `Miró 对设计世界的影响被严重低估了。他不只是一个"抽象画家"--他是20世纪视觉语言的重要建筑师。

1982年西班牙世界杯的官方标志直接借用了 Miró 的风格--事实上就是 Miró 本人设计的,这是他去世前一年完成的最后几件重要作品之一。西班牙旅游局的太阳标志(Turespaña logo, 1983)也出自 Miró 之手。La Caixa 银行那颗著名的星形logo,虽然不是 Miró 直接设计的,但灵感来源显而易见。

更深层的影响在于他证明了一件事:最复杂的情感可以用最简单的形状表达。三条线和两个圆点可以是一张脸,一颗星星可以代表希望,一抹红色可以是心跳。这种"少即是多"的视觉哲学,和包豪斯从功能角度的极简不同--Miró 的极简是从情感角度出发的,带着地中海的热情和孩童般的直觉。

今天你打开任何一个科技公司的品牌手册,看到那些"友好的""有机的""人性化的"插画风格--用简单的形状传达复杂的情感--背后都有 Miró 的影子。从 Google Doodle 到 Slack 的品牌插画,Miró 开创的那条路,至今仍是设计师最常走的路之一。`,
    significance: `Miró 最深远的贡献,是打破了"艺术"和"设计"之间那道假装存在的墙。他既画挂在 MoMA 的巨幅油画,也为西班牙国家做品牌设计;既做博物馆里的青铜雕塑,也设计陶瓷和织毯。他证明了同一套视觉思维可以在画布和logo之间自由切换--这在他的时代是激进的,在今天则已经成为常识。

《Harlequin's Carnival》本身就是这种跨界思维的早期宣言。画中的每个符号--星星、眼睛、音符--都有独立存在的能力,可以被提取、放大、重新组合。这正是现代品牌设计的核心方法论:创造一套可拆解、可重组的视觉元素。

93岁去世时,Miró 已经在巴塞罗那、马略卡岛和巴黎留下了三座以他命名的基金会和美术馆。但他最大的遗产不在任何一面墙上--它在每一个试图用简单形状传达复杂意义的设计师的工具箱里。`,
