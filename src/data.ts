...
Every design decision — tubular structure, Gothic base, aluminum cladding — fused function with poetry. Yamasaki proved that supertall buildings need not be cold steel boxes; they could possess ceremony, rhythm, and human warmth.`,
  },
  {
    ...
    dateConnection: '1994年4月5日，Kurt Cobain 在西雅图家中去世。对 Nirvana 乐队的歌迷来说，这一天既是巨大的悲痛，也是对 Nevermind 专辑的艺术和文化价值的深刻记忆投射。',
    ...
    designerBio: `Nevermind 专辑封面由 Robert Fisher 设计，摄影师 Kirk Weddle 拍摄。这幅封面的设计源自 Kurt Cobain 关于“水中追逐美元”的灵感，最终成为 20 世纪最具辨识度、最经典的图像之一。Fisher 和 Weddle 的合作，通过巧妙的画面构图和精准的表达，捕捉了几乎所有人类社会能理解的主题——对金钱的追逐。`,
    story: `Nevermind 的封面不仅仅是一副照片，而是将 Nirvana 的音乐、Kurt Cobain 的思想，以及 90 年代蓬勃成长的叛逆文化结合为一体的视觉声明。胎儿般的婴儿在水中伸手抓向一美元钞票，一根鱼线暗示了对金钱的无形操控。这不仅是 grunge 音乐美学在商业世界中首次登堂入室的重要象征，也是普遍意义上的反思和控诉。`,
    legacy: 'Nevermind 封面成为现代专辑设计的风向标，也是平面设计与流行文化的经典案例。MoMA 将它纳入永久收藏，进一步巩固了它的艺术历史地位。',
    significance: 'Nevermind 封面定义了 90 年代的音乐形象，并且数十年后仍然是文化多样性的显著标志。它启发了无数后来的艺术家、音乐人和视觉设计师。',
